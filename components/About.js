        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          ...
          >
            ...
            <p className="mt-4 text-lg leading-relaxed text-muted-foreground">
              Мы — команда психиатров, психотерапевтов и психологов, которые
              более 12 лет помогают людям справляться с тревогой, депрессией и
              стрессом и возвращаться к полноценной жизни. Мы не осуждаем и не
              давим — создаём условия, в которых человеку становится легче.
            </p>
